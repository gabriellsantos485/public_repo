(function () {
  ...
  var CATEGORIAS = [{"chave": "necessario", "titulo": "Necessários", "descricao": "Essenciais para o funcionamento do site (sessão, segurança, carrinho de compras). Não podem ser desativados.", "obrigatorio": true, "servicos": [{"chave": "localhost", "nome": "localhost", "dominio": "localhost", "cookies": [["carrinho_id", "/", "localhost"], ["sessionid", "/", "localhost"]]}]}, {"chave": "analitico", "titulo": "Estatísticas", "descricao": "Ajudam a entender como os visitantes usam o site (métricas de uso, mapas de calor).", "obrigatorio": false, "servicos": [{"chave": "localhost", "nome": "localhost", "dominio": "localhost", "cookies": [["_ga", "/", "localhost"], ["_gid", "/", "localhost"], ["_hjSessionUser_1234567", "/", "localhost"], ["_clck", "/", "localhost"]]}]}, {"chave": "publicidade", "titulo": "Marketing", "descricao": "Usados para exibir anúncios relevantes e medir campanhas publicitárias.", "obrigatorio": false, "servicos": [{"chave": "localhost", "nome": "localhost", "dominio": "localhost", "cookies": [["_fbp", "/", "localhost"]]}]}];
